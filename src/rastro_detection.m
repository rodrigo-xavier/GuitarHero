function [holding_buttons, holding_times] = rastro_detection(galileo, imgO, holding_buttons, holding_times)
    ...
    if( ~holding_buttons('green') && ...
        ...
        fprintf(galileo,'%c', APERTA_SEM_SOLTA_GREEN);  
    end
    ...
    if( ~holding_buttons('orange') && ...
        (imgO(294,387,:) >= orangeR_min && imgO(294,387,:) <= orangeR_max) && ...
        (imgO(294,387,:) >= orangeG_min && imgO(294,387,:) <= orangeG_max) && ...

        (imgO(293,387,:) >= orangeR_min && imgO(293,387,:) <= orangeR_max) && ...
        (imgO(293,387,:) >= orangeG_min && imgO(293,387,:) <= orangeG_max) && ...

        (imgO(292,386,:) >= orangeR_min && imgO(292,386,:) <= orangeR_max) && ...
        (imgO(292,386,:) >= orangeG_min && imgO(292,386,:) <= orangeG_max) && ...

        (imgO(291,386,:) >= orangeR_min && imgO(291,386,:) <= orangeR_max) && ...
        (imgO(291,386,:) >= orangeG_min && imgO(291,386,:) <= orangeG_max) && ...

        (imgO(290,386,:) >= orangeR_min && imgO(290,386,:) <= orangeR_max) && ...
        (imgO(290,386,:) >= orangeG_min && imgO(290,386,:) <= orangeG_max) && ...

        (imgO(289,385,:) >= orangeR_min && imgO(289,385,:) <= orangeR_max) && ...
        (imgO(289,385,:) >= orangeG_min && imgO(289,385,:) <= orangeG_max) && ...

        (imgO(288,385,:) >= orangeR_min && imgO(288,385,:) <= orangeR_max) && ...
        (imgO(288,385,:) >= orangeG_min && imgO(288,385,:) <= orangeG_max) && ...

        (imgO(287,385,:) >= orangeR_min && imgO(287,385,:) <= orangeR_max) && ...
        (imgO(287,385,:) >= orangeG_min && imgO(287,385,:) <= orangeG_max) && ...

        (imgO(286,384,:) >= orangeR_min && imgO(286,384,:) <= orangeR_max) && ...
        (imgO(286,384,:) >= orangeG_min && imgO(286,384,:) <= orangeG_max) && ...

        (imgO(285,384,:) >= orangeR_min && imgO(285,384,:) <= orangeR_max) && ...
        (imgO(285,384,:) >= orangeG_min && imgO(285,384,:) <= orangeG_max) && ...

        (imgO(284,384,:) >= orangeR_min && imgO(284,384,:) <= orangeR_max) && ...
        (imgO(284,384,:) >= orangeG_min && imgO(284,384,:) <= orangeG_max) && ...

        (imgO(283,383,:) >= orangeR_min && imgO(283,383,:) <= orangeR_max) && ...
        (imgO(283,383,:) >= orangeG_min && imgO(283,383,:) <= orangeG_max) && ...

        (imgO(282,382,:) >= orangeR_min && imgO(282,382,:) <= orangeR_max) && ...
        (imgO(282,382,:) >= orangeG_min && imgO(282,382,:) <= orangeG_max) )
