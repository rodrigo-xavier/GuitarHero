function [note_time, trail_time] = detect_times(vid)
    ...
    while (note < note_max)
        ...
        if(greenPixelMidle >= green_min && greenPixelMidle <= green_max && ...
            toc(tictoc_g1) > tictoc_min && toc(tictoc_g1) <= tictoc_max_trail)
        ...
        if(redPixelMidle >= red_min && redPixelMidle <= red_max && ...
            toc(tictoc_r1) > tictoc_min && toc(tictoc_r1) <= tictoc_max_trail)

            temp = toc(tictoc_r1);
            tictoc_r2 = tic;
        end
        if(redPixelDown >= red_min && redPixelDown <= red_max && ...
            toc(tictoc_r2) > tictoc_min && toc(tictoc_r2) <= tictoc_max_note)
        ...
        if(yellowPixelRMidle >= yellowR_min && yellowPixelRMidle <= yellowR_max && ...
            ...
            toc(tictoc_y1) > tictoc_min && toc(tictoc_y1) <= tictoc_max_trail)
        ...
        if(yellowPixelRDown >= yellowR_min && yellowPixelRDown <= yellowR_max && ...
            ...
            toc(tictoc_y2) > tictoc_min && toc(tictoc_y2) <= tictoc_max_note)
        ...
        if(bluePixelGMidle >= blueG_min && bluePixelGMidle <= blueG_max && ...
            ...
            toc(tictoc_b1) > tictoc_min && toc(tictoc_b1) <= tictoc_max_trail)
        ...
        if(bluePixelGDown >= blueG_min && bluePixelGDown <= blueG_max && ...
            ...
            toc(tictoc_b2) > tictoc_min && toc(tictoc_b2) <= tictoc_max_note)
        ...
        if(orangePixelRMidle >= orangeR_min && orangePixelRMidle <= orangeR_max && ...
            ...
            toc(tictoc_o1) > tictoc_min && toc(tictoc_o1) <= tictoc_max_trail)
        ...
        if(orangePixelRDown >= orangeR_min && orangePixelRDown <= orangeR_max && ...
            ...
            toc(tictoc_o2) > tictoc_min && toc(tictoc_o2) <= tictoc_max_note)
